...
public class FileArrayAdapter extends ArrayAdapter<Option> { //FileArrayAdapter
	...
	@Override
	public View getView(int position, View convertView, ViewGroup parent) {	//파일의 아이콘과 이름을 붙여서 리턴
		View v = convertView;
		if (v == null) {
